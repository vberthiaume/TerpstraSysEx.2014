...
#ifndef LUMATONE_VIEW_COMPONENTS_H
#define LUMATONE_VIEW_COMPONENTS_H
...
{
public:
	LumatoneKeyEdit(const LumatoneEditorState& state, int boardIndex, int keyIndex);
	~LumatoneKeyEdit();
...
private:
	...
	const LumatoneEditorState& state;
...
#endif LUMATONE_VIEW_COMPONENTS_H
