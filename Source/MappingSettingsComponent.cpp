...
//==============================================================================
MappingSettingsComponent::MappingSettingsComponent (const LumatoneEditorState& stateIn)
    : LumatoneEditorState("MappingSettingsComponent", stateIn)
{
...
MappingSettingsComponent::~MappingSettingsComponent()
{
...
//==============================================================================
void MappingSettingsComponent::paint (juce::Graphics& g)
{
...
void MappingSettingsComponent::resized()
{
    float w = getWidth();
    float h = getHeight();
...
void MappingSettingsComponent::loadFromMapping()
{
...
void MappingSettingsComponent::exprSensitivitySliderCallback()
{
...
void MappingSettingsComponent::lightOnKeyStrokesChanged(bool lightOn)
{
    buttonLightOnKeyStrokes->setToggleState(getLightOnKeyStrokes(), dontSendNotification);
}

void MappingSettingsComponent::aftertouchToggled(bool enabled)
{
    buttonAfterTouchActive->setToggleState(getAftertouchOn(), dontSendNotification);
}

void MappingSettingsComponent::expressionPedalSensitivityChanged(unsigned char value) 
{
    sldExprCtrlSensitivity->setValue(getExpressionSensitivity(), dontSendNotification);
}

void MappingSettingsComponent::invertFootControllerChanged(bool inverted) 
{
    btnInvertExpression->setToggleState(getInvertExpression(), dontSendNotification);
}

void MappingSettingsComponent::invertSustainToggled(bool inverted) 
{
    btnInvertSustain->setToggleState(getInvertSustain(), dontSendNotification);
}

void MappingSettingsComponent::firmwareVersionChanged()
{
