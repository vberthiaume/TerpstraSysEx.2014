...
class MappingSettingsComponent : public juce::Component
                               , public LumatoneEditorState
                               , public LumatoneEditor::EditorListener
{
public:
    MappingSettingsComponent(const LumatoneEditorState& stateIn);
    ~MappingSettingsComponent() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MappingSettingsComponent)
};
